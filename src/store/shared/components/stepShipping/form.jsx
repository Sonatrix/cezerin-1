...
class CheckoutStepShipping extends React.Component {
  ...
  render() {
    ...
    //  we get grand_total in initial values
    const {payment_method_gateway: paymentMethodGateway} = initialValues;
    const showPaymentForm = paymentMethodGateway && paymentMethodGateway !== '';
